...
class NexusThemes {
  static final lightTheme = ThemeData(
    ...
    cardColor: NexusColors.backgroundColorLight, // You can use backgroundColorLight as cardColor
    canvasColor: NexusColors.backgroundColorLight, // You can use backgroundColorLight as canvasColor
    dividerColor: NexusColors.borderColor, // You can use borderColor as dividerColor
    focusColor: NexusColors.primaryColorLight, // You can use primaryColorLight as focusColor
    splashColor: NexusColors.primaryColorLight.withOpacity(0.3), // You can adjust the opacity as needed
  ...
  static final darkTheme = ThemeData(
    ...
    cardColor: NexusColors.backgroundColorDark, // You can use backgroundColorDark as cardColor
    canvasColor: NexusColors.backgroundColorDark, // You can use backgroundColorDark as canvasColor
    dividerColor: NexusColors.borderColor, // You can use borderColor as dividerColor
    focusColor: NexusColors.primaryColorDark, // You can use primaryColorDark as focusColor
    splashColor: NexusColors.primaryColorDark.withOpacity(0.3), // You can adjust the opacity as needed
    // Add other colors as needed
  );
}
